  ...
  const defaultConfig = {
    ...
    columns: [
      {
        title: 'Produits',
        links: [
          { text: 'Entraînement & Performance', url: '/produits/entrainement-performance' },
          { text: 'Athleisure', url: '/produits/athleisure' }
        ]
      },
      {
        title: 'Entreprise',
    ...
    copyright: {
      ...
      links: [
        ...
        { text: 'Conditions Générales', url: '/conditions-generales' }
      ]
    },
