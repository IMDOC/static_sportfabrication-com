...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      '.fw-section--dark .fw-input:focus{border-color:' + config.accentColor + ';background:rgba(255,255,255,.12);box-shadow:0 0 0 3px rgba(239,68,68,.14)}',
      ...
      '.fw-section--dark .fw-side::after{background:radial-gradient(circle,rgba(239,68,68,.18),transparent 68%)}',
      ...
      '.fw-section--light .fw-input:focus{border-color:' + config.brandColor + ';box-shadow:0 0 0 3px rgba(29,78,216,.12)}',
      '.fw-section--light .fw-side{border:1px solid rgba(15,31,30,.08);background:#FAF7F2}',
      '.fw-section--light .fw-side::after{background:radial-gradient(circle,rgba(29,78,216,.10),transparent 68%)}',
